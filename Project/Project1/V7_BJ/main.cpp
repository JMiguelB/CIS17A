 ...
 * Purpose:  Blackjack(21) Project 2 Version 3
 *           add to convert Ace value from 11 to 1 to prevent busting
 */
...
void dTurn(string name, int &pTotal, int &cTotal, int &wins, int &topCard,
        string deck[], int deckVal[], int size, int &cAces) { //dealer's turn
